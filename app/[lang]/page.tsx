...
const getLandingPage = async (lang: string) => {
    ...
    const { nav_section, hero_section, services_section, contact_section, testimonials_section, footer_section } = storyData.story.content;
...
export default async function Home({ params: { lang } }: { params: { lang: string } }) {
    const { nav_section, hero_section, services_section, contact_section, testimonials_section, footer_section, loire_map_section } = await getLandingPage(lang);
